    ...
    if (showDiscardConfirm) {
        return (
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-in fade-in duration-200">
                <Card className="w-full max-w-sm p-6 space-y-4 shadow-xl bg-white">
                    <h3 className="text-lg font-bold text-red-600">Discard Session?</h3>
                    <p className="text-gray-600">This cannot be undone. The session data will be lost.</p>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-in fade-in duration-200">
            <div className="bg-white rounded-xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-hidden flex flex-col">
                ...
                <div className="p-4 border-b border-gray-100 flex items-center justify-between bg-gray-50">
                    <div>
                        <h2 className="text-lg font-bold">Session Review</h2>
                ...
                <div className="p-6 overflow-y-auto space-y-6 flex-1">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                type="text"
                                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-gray-900 focus:outline-none"
                    ...
                    <div className="space-y-3 p-4 bg-gray-50 rounded-lg border border-gray-100">
                        ...
                        <input
                            type="text"
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-gray-900 focus:outline-none bg-white"
                    ...
                    <div className="space-y-2 text-center">
                        <label className="text-sm font-medium text-gray-700">Focus Rating</label>
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-gray-900 focus:outline-none min-h-[80px] resize-y"
